    ...
    function vehicleDetails() {
        return (
            ...
            <div className="row m-3">
                ...
                <div className="col-sm col-md-6">
                    <div className="form-outline mb-4">
                        <label className="fs-6 fw-bolder mb-2">Category <span className="text-danger"> * </span></label>
                ...
                <div className="col-sm col-md-6">
                    <div className="form-outline mb-4">
                        <label className="fs-6 fw-bolder mb-2">Average Mileage <span className="text-danger"> * </span></label>
                        <input type="text" className="form-control form-control-lg"
                            placeholder="Enter Average mileage of the car..."
                            id="average"
